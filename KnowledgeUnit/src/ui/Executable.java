...
public class Executable {
	...
	public void createAProject() {
		...
		if(controller.createAProject(idProject, projectName, clientName, projectType, initialDateDay, initialDateMonth, initialDateYear, budget, companyManager, companyManagerPhone, clientManager, clientManagerPhone, beginningMonthDuration, analysisMonthDuration, designMonthDuration, executionMonthDuration, closureMonthDuration, followingAndControlMonthDuration)){
	...
	public void registerKnowledgeUnit() {
		...
		if(controller.countAllProjects() > 0){

			System.out.println("Enter the information necesary for register a capsule");

			System.out.println("Please type the project position");
			...
			if(controller.searchSpecificProject(projectPosition)){
				...
				if(controller.countCapsulesForStage(capsuleInformation) <= 50){
					...
					if(controller.registerKnowledgeUnit(projectPosition, id, capsuleInformation, description, type, learnedLessons)){
			...
			System.out.println("There are no projects registered in the program");
	...
	public void approveStage() {
		...
		if(consult.equals("")){
			...
			controller.approveStage(projectPosition, approvationStageDay, approvationStageMonth-1, approvationStageYear);
