...
public class Executable {
	...
	private void deleteProduct() {
		...
		if (query.equals("")) {
			...
			System.out.println("\nThis is the list of products registered in the system");
		...
		if (users.equals("")){
			...
			if (election == 1) {
				...
				if (books.equals("")) {
					...
					if (shop.sellBook(userPosition, election, bookPosition)) {
				...
				if (magazines.equals("")) {
					...
					if (shop.sellBook(userPosition, election, magazinePosition)) {
	...
	private void userLibrary() {
		...
		if (query.equals("")) {
			...
			while(!list){
				...
				String suscriptions = shop.library(ubication, option);

				if (suscriptions.equals("")){

					System.out.println("No books in the user library");
					list = true;
					...
					if (action.equals("A")){
						...
						while(!simulationFlag){
							...
							String simulation = shop.readingSimulation(action, pagesReaded, simulationAction);
